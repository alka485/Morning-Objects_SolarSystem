...
const solarSystem = [
    ...
    // 5. Add a new key value pair to the the Earth object: the key should be 'diameter', and the value should be Earth's diameter in miles represented as a string.
     solarSystem.find(planet => planet.name ==="Earth").diameter = "79716";
...
if(typeof(system.mercury.radiusp) === "string") {
    system.mercury.radiuse = system.mercury.radiusp;
...
const jupmomentum  = system.jupiter.mass * system.jupiter.velocity;
const pulmomentum = system.pluto.mass  * system.pluto.velocity;

const diff = jupmomentum - pulmomentum;
